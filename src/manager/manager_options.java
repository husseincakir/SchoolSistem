...
public class manager_options extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Manager options");
    ...
    private void jButtoneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtoneditActionPerformed
        ...
        manageredit.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manager_options.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new manager_options().setVisible(true);
            }
        });
    }
